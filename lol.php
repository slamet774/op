...
echo color("green","| Slamet Harianto                           |\n");
echo " ============================================\n";
...
//function change(){
       ...
       // $no = trim(fgets(STDIN));
        ...
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOOD2107"}');
        ...
        $boba19 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PESANGOFOOD2107"}');
        ...
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADIMART"}');
